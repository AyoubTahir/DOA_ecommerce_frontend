...
export const categories = () => async (dispatch) => {
  try
  {
    ...
    dispatch({ type: actionType.CATEGORIES_SUCCESS, data: data.categories })
...
export const addCategory = (inputs, navigate) => async (dispatch) => {
  try
  {
    ...
    dispatch({ type: actionType.ADD_CATEGORY_SUCCESS, data })
  ...
  {
    dispatch({ type: actionType.ADD_CATEGORY_FAILURE, error: error?.response?.data })
