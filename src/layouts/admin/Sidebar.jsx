          ...
          <div>
            ...
            <a className="link-fx fw-bold tracking-wide mx-auto" href="index.html">
              <span className="smini-hidden">
                ...
                <span className="fs-4 text-dual"> DOA</span><span className="fs-4 text-primary"> ECOM</span>
              </span>
            </a>
          </div>

          <div>
            <button type="button" className="btn btn-sm btn-alt-danger d-lg-none" onClick={handleSidebarToggle} data-toggle="layout" data-action="sidebar_close">
            ...
            <div className="smini-hidden text-center mx-auto">
              ...
              <ul className="list-inline mt-3 mb-0">
                <li className="list-inline-item">
                  <a className="link-fx text-dual fs-sm fw-semibold text-uppercase" href="be_pages_generic_profile.html">{authName}</a>
                </li>
                <li className="list-inline-item">
                  <button className="link-fx text-dual" style={{background: "transparent", border: "none"}} onClick={handleMode}>
                    <i className="fa fa-burn"></i>
                  </button>
                </li>
                <li className="list-inline-item">
                  <button className="link-fx text-dual" style={{background: "transparent", border: "none"}} onClick={handleLogout} >
